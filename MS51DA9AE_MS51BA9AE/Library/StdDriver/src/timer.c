...
/**
  ...
  * @exmaple :  Timer0_AutoReload_Interrupt_Initial(24,6400);
*/
#if 0
...
/**
  ...
  * @exmaple :  fsys = 8MHz, delay 6.4ms  : Timer2_AutoReload_Interrupt_Initial(24,6400);
*/
#if 0    
...
/**
  ...
  * @exmaple :  fsys = 8MHz, delay 6.4ms  : Timer3_AutoReload_Interrupt_Initial(24,6400);
*/
#if 0
